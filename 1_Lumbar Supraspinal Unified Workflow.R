...
#Assign (or "map") each seurat cluster ID to an anatonical name, called a "manual.cluster.1" 

#Read a csv that has the seurat/manual.cluster correspondence as two colums with matched terms by row
...
#By having the terms ordered properly in the input csv alread loaded, the following command will reorder the seurat
